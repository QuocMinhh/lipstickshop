                            ...
                            <table id="keywords" cellspacing="0" cellpadding="0">
                                ...
                                <tbody>
                                    ...
                                    if (isset($_POST['change'])) {
                                        ...
                                        $infor_cart = mysqli_query($connectdb, "select * from products where id_pd = '$id_pd'");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="lalign">
                                                <?php echo "<img id='output' src ='../img/" . $products['images'] . "'width='100' height='100'>" ?>
                                                <input type="file" name="img" accept="image/*"
                                                    onchange="document.getElementById('output').src = window.URL.createObjectURL(this.files[0])">
                                            </td>
                                            <td>
                                                <input type="text" name='name' placeholder="name products" id="name"
                                                    <?php echo "value = " . $products['name_pd'] . "" ?>>

                                            </td>
                                            <td>
                                                <input type="text" name='price' placeholder="$" id="price"
                                                    <?php echo "value = " . $products['price_pd'] . "" ?>>

                                            </td>
                                            <td>
                                                <input type="text" name='quantity' id="quantity"
                                                    <?php echo "value = " . $products['quantity_pd'] . "" ?>>

                                            </td>
                                            <td>
                                                <input type="text" name='made-in' id="madein"
                                                    <?php echo "value = " . $products['made_in'] . "" ?>>
